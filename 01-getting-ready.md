...
## Noget om tokenisation fra lesson 0
When tokenizing our text to make it tidy, the metadata that describe the whole speech are carried over to 
...
Tokenization of text into individual tokens is necessary for text mining because it allows us to analyze the text closely and in detail, analyses which can later be visualized to understand the patterns of the text. 

In this course we will use words as token

## Noget om stopwords flyttet fra lesson 0
